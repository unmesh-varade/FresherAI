    ...
    <div className='bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden'>
        ...
        <section className="relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              <img
                src={img}
                alt="Freshly.Ai Dashboard"
                className="w-full h-auto object-cover block "
                onError={(e) => {
                  e.target.src =
                    "https://placehold.co/900x500/F3F4F6/0A0A0A?text=Freshly.Ai+Dashboard";
                }}
              />
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -10,x : -5, scale: 1.02}}
        ...
        {showLogin && <LoginModal onClose={()=>setShowLogin(false)} setUser={setUser}/> }
          ...
          <footer className='border-t border-black/7 py-6 text-center bg-white'>
            ...
            <div className='text-black/40 text-xs'>© {new Date().getFullYear()} Fresher.AI · All rights reserved</div>
          </footer>
    </div>
  )
}
